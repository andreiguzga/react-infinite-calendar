...
var Month = function (_PureComponent) {
  ...
  Month.prototype.renderRows = function renderRows() {
    ...
    var selectedDayWeeks = (0, _utils.weekHasSelectedDay)(year, month, selected, locale.weekStartsOn);
    ...
    for (var i = 0, len = rows.length; i < len; i++) {
      ...
      monthRows[i] = _react2.default.createElement(
        ...
        withTimes && _react2.default.createElement(
          ...
          _react2.default.createElement(_index2.default, _extends({ hasSelectedDay: hasSelectedDay }, passThrough.Time))
        )
      );
    }
