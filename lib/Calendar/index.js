...
Calendar.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  onMonthLoad: _propTypes2.default.func,
  withTimes: _propTypes2.default.bool,
  availableTimes: _propTypes2.default.arrayOf(_propTypes2.default.string),
