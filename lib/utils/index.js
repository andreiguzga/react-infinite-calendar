...
exports.monthHasSelectedDay = monthHasSelectedDay;
exports.weekHasSelectedDay = weekHasSelectedDay;
...
function monthHasSelectedDay(year, month, selectedDate, weekStartsOn) {
...
function weekHasSelectedDay(year, month, selectedDate, weekStartsOn) {
  var result = [];
